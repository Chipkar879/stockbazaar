...
// 1. Core authentication form element containing the search parameter hooks
function SignupForm() {
...
// 2. Main structure wrapping everything inside a Next.js safe Suspense boundary wrapper
  ...
  return (
    <main className="min-h-screen bg-[#f5f7ff] text-[#1e1b4b] antialiased">
      ...
      <section className="max-w-md mx-auto px-6 pt-16 pb-12">
        <Suspense fallback={
          <div className="w-full bg-white border border-slate-200 rounded-3xl p-8 shadow-sm text-center text-slate-400 text-xs font-bold animate-pulse">
            Configuring authentication tunnels...
          </div>
        }>
          <SignupForm />
        </Suspense>
