...
export default function Home() {
  ...
  return (
    <main className="min-h-screen bg-black text-slate-100 antialiased font-sans pb-20 overflow-x-hidden relative">
      <Navbar />
      ...
      <section className="max-w-7xl mx-auto px-6 pt-16 text-center space-y-8 relative z-10">
        ...
        <div className="space-y-4 max-w-3xl mx-auto select-none animate-fadeIn">
          ...
          <h1 className="text-4xl sm:text-7xl font-black tracking-tight leading-none text-white">
            ...
            Before the{' '}
            <span className="bg-gradient-to-r from-[#dc2626] via-[#6e1313] to-white bg-clip-text text-transparent drop-shadow-sm font-black">
              Bell Rings
            </span>
          </h1>
